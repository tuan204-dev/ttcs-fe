...
const isPositioned = (element) => getComputedStyle(element).position !== 'static';
    ...
    if (horizontal) {
        ...
        if (isPositioned(c)) {
            if (t.offsetParent !== c) {
                ...
                const { offsetTop, offsetParent } = getElementOffsetInfoUntil(t, isContainerElementOrDocument);
